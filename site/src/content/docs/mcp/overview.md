...
Floci Studio ships with a built-in [Model Context Protocol](https://modelcontextprotocol.io) (MCP) server. It exposes 112 tools across 19 service modules (plus any community plugins), giving any MCP-compatible AI client full operational control over your local AWS environment.
...
| `devtools` | 6 | Terraform export, AWS CLI escape hatch, JWT, proxy |
