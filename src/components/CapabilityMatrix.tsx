...
const SERVICES_DATA: CapabilityServiceInfo[] = [
  ...
  { key: 'cognito', name: 'Cognito Pools', category: 'Security & Identity', type: 'native', endpoint: 'Browser-Direct (SDK)', storage: 'Localstack Memory', description: 'User pools, identity pools and developer authentication.' },
