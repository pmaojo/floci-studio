...
const SERVICES_DATA: CapabilityServiceInfo[] = [
  ...
  { key: 'apigateway', name: 'API Gateway', category: 'Networking & Content', type: 'native', endpoint: 'Browser-Direct (SDK)', storage: 'Localstack Memory', description: 'REST APIs, resources and method definitions.' },
